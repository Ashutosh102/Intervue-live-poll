...
export function StudentDashboard() {
  ...
  const handleContinue = () => {
    if (name.trim()) {
      ...
      dispatch(setUserInfo({ name: name.trim(), id: newUserId }))
      socketService.connectAsStudent(newUserId, name)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-xl text-center">
          {/* Logo */}
          <div className="inline-flex items-center gap-2 text-white px-4 py-2 rounded-full mb-12"
          style={{
          ...
          <p className="text-gray-600 mb-12 max-w-md mx-auto">
            ...
            <span className="font-semibold text-black">submit your answers</span>, participate in live
          ...
          <div className="space-y-6 max-w-md mx-auto">
            <div className="text-left">
              ...
              <Input
                ...
                className="w-full p-4 text-lg bg-gray-50"
              />
            </div>
            ...
            <Button
              ...
              disabled={!name.trim()}
              className="w-full bg-purple-600 hover:bg-purple-700 text-white py-6 text-lg rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Continue
            </Button>
          </div>
  ...
  if (currentQuestion) {
    return <QuestionDisplay userName={name} question={currentQuestion} onSubmit={handleQuestionSubmit} />
  }
