    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <RoleCard
            title="I'm a Student"
            description="Submit answers and participate in live polls with your classmates"
            isSelected={selectedRole === 'student'}
            onClick={() => handleRoleSelect('student')}
          />
          <RoleCard
            title="I'm a Teacher"
            description="Create polls and monitor student responses in real-time"
        ...
        <div className="flex justify-center">
          <button
            ...
            className="bg-purple-500 text-white px-8 py-3 rounded-full font-semibold
